...
public class ControlaEC implements ActionListener, FocusListener {
    ...
    private boolean cpf = false,nome = false,endereco = false,cidade= false,estado= false,telefone= false, email = false;
    ...
    public void focusGained(FocusEvent e) {
        if (e.getSource().equals(EDITAR_CLIENTE.getTxtCPF())) {
            ...
            menu.setLocation(EDITAR_CLIENTE.getTxtCPF().getX() + 90, EDITAR_CLIENTE.getTxtCPF().getY() + 6 * EDITAR_CLIENTE.getTxtCPF().getHeight());
    ...
    private void validaCpfCliente() {
        ...
        if (EDITAR_CLIENTE.getTxtCPF().getText() == null || EDITAR_CLIENTE.getTxtCPF().getText().equals("") || EDITAR_CLIENTE.getTxtCPF().getText().equals(" ")) {
    ...
    private void validaNome(){
        if (EDITAR_CLIENTE.getTxtNome().getText() == null || EDITAR_CLIENTE.getTxtNome().getText().equals("") || EDITAR_CLIENTE.getTxtNome().getText().equals(" ")) {
            nome=false;
        }else{
            nome = true;
    ...
    private void validaEndereco(){
        if (EDITAR_CLIENTE.getTxtEndereco().getText() == null || EDITAR_CLIENTE.getTxtEndereco().getText().equals("") || EDITAR_CLIENTE.getTxtEndereco().getText().equals(" ")) {
            endereco=false;
        }else{
            endereco = true;
    ...
    private void validaCidade(){
        if (EDITAR_CLIENTE.getTxtCidade().getText() == null || EDITAR_CLIENTE.getTxtCidade().getText().equals("") || EDITAR_CLIENTE.getTxtCidade().getText().equals(" ")) {
    ...
    private void validaUF(){
        if (EDITAR_CLIENTE.getTxtMs().getText() == null || EDITAR_CLIENTE.getTxtMs().getText().equals("") || EDITAR_CLIENTE.getTxtMs().getText().equals(" ")) {
            estado = false;
    ...
    private void validaTelefone(){
        if (EDITAR_CLIENTE.getTxtTelefone().getText() == null || EDITAR_CLIENTE.getTxtTelefone().getText().equals("") || EDITAR_CLIENTE.getTxtTelefone().getText().equals(" ")) {
            telefone =false;
        }
        else{
            telefone=true;
    ...
    private void validaEmail(){
        if (EDITAR_CLIENTE.getTxtEmail().getText() == null || EDITAR_CLIENTE.getTxtEmail().getText().equals("") || EDITAR_CLIENTE.getTxtEmail().getText().equals(" ")) {
            email=false;
    ...
    private void confirma(){
        int conf = JOptionPane.showConfirmDialog(null, "Deseja confirmar a atualiza\u00e7\u00e3o", "Confirmar", JOptionPane.YES_NO_OPTION);
