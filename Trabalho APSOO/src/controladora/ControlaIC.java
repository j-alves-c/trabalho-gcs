...
public class ControlaIC implements ActionListener, FocusListener {
    ...
    private boolean cpf = false,nome = false,dataAtual= false,rua= false,bairro= false,numero= false,cidade= false,estado= false,telefone= false, email = false;
    ...
    private void validaCpfCliente() {
      ...
      if (INSERIR_CLIENTE.getTxtCPF().getText() == null || INSERIR_CLIENTE.getTxtCPF().getText().equals("") || INSERIR_CLIENTE.getTxtCPF().getText().equals(" ")) {
    ...
    private void validaNome(){
        if (INSERIR_CLIENTE.getTxtNome().getText() == null || INSERIR_CLIENTE.getTxtNome().getText().equals("") || INSERIR_CLIENTE.getTxtNome().getText().equals(" ")) {
    ...
    private void validaBairro(){
        if (INSERIR_CLIENTE.getTextBairro().getText() == null
    ...
    private void validaNumero(){
        if (INSERIR_CLIENTE.getTextNumero().getText() == null
    ...
    private void validaCidade(){
        if (INSERIR_CLIENTE.getTxtCidade().getText() == null || INSERIR_CLIENTE.getTxtCidade().getText().equals("") || INSERIR_CLIENTE.getTxtCidade().getText().equals(" ")) {
    ...
    private void validaUF(){
        if (INSERIR_CLIENTE.getTxtUF().getText() == null || INSERIR_CLIENTE.getTxtUF().getText().equals("") || INSERIR_CLIENTE.getTxtUF().getText().equals(" ")) {
    ...
    private void validaTelefone(){
        if (INSERIR_CLIENTE.getTxtTelefone().getText() == null || INSERIR_CLIENTE.getTxtTelefone().getText().equals("") || INSERIR_CLIENTE.getTxtTelefone().getText().equals(" ")) {
    ...
    private void validaEmail(){
        if (INSERIR_CLIENTE.getTxtEmail().getText() == null || INSERIR_CLIENTE.getTxtEmail().getText().equals("") || INSERIR_CLIENTE.getTxtEmail().getText().equals(" ")) {
    ...
    private void cadastrarCliente(){
        if (cpf && nome && dataAtual && rua && bairro && numero && estado && cidade && telefone && email){
            ...
            String endereco = INSERIR_CLIENTE.getTxtRua().getText() +","+ INSERIR_CLIENTE.getTextNumero().getText() +" - " + INSERIR_CLIENTE.getTextBairro().getText() ;
